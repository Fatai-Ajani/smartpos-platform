...
'            https://www.',
'          </span>',
'          <Input className="rounded-l-none" value={value.website ?? ""} onChange={update("website")} />',
'        </div>',
'      </div>',
'',
'      <div>',
'        <Label>Country *</Label>',
'        <CountrySelect value={value.country} onChange={updateValue("country")} />',
'      </div>',
'',
'      <div>',
'        <Label>Currency *</Label>',
'        <CurrencySelect value={value.currency} onChange={updateValue("currency")} />',
'      </div>',
'',
'      <div>',
'        <Label>State</Label>',
'        <StateSelect country={value.country} value={value.state ?? ""} onChange={updateValue("state")} />',
'      </div>',
'',
'      <div>',
'        <Label>City</Label>',
'        <CitySelect country={value.country} state={value.state ?? ""} value={value.city ?? ""} onChange={updateValue("city")} />',
'      </div>',
'',
'      <div className="md:col-span-2">',
'        <Label>Address</Label>',
...
console.log("merchant-form.tsx rebuilt successfully");
